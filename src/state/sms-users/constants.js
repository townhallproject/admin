...
export const RECEIVE_POTENTIAL_VOLS = makeConstant(STATE_BRANCH, "RECEIVE_POTENTIAL_VOLS");
export const REQUEST_POTENTIAL_VOLS = makeConstant(STATE_BRANCH, "REQUEST_POTENTIAL_VOLS");
export const UPDATE_POTENTIAL_VOLS_SUCCESS = makeConstant(STATE_BRANCH, "UPDATE_POTENTIAL_VOLS_SUCCESS");
export const UPDATE_POTENTIAL_VOLS = makeConstant(STATE_BRANCH, "UPDATE_POTENTIAL_VOLS");
